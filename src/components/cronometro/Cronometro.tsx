...
export const Cronometro: React.FC = () => {
  ...
  return (
    <section className="absolute top-0 left-0 w-full h-full p-5 pb-[100px] overflow-y-auto">
      ...
      <div className="bg-white p-[30px] rounded-[24px] shadow-[6px_6px_12px_#e6e6e6,-6px_-6px_12px_#ffffff] flex flex-col items-center gap-[25px] mt-5">
        <div
          className="w-[200px] h-[200px] rounded-full flex items-center justify-center shadow-[4px_4px_10px_#e6e6e6]"
        ...
        >
          <div className="w-[175px] h-[175px] bg-white rounded-full flex items-center justify-center shadow-[inset_4px_4px_8px_#e6e6e6,inset_-4px_-4px_8px_#ffffff]">
            <span className="text-4xl font-bold text-[#333333]">{tiempoFormateado}</span>
          </div>
        </div>
